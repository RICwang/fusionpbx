<?php
	...
	//application details
		...
		$apps[$x]['description']['zh-cn'] = "要接收传真，请设置传真分机，然后使用专用号码引导传入的传真，或者您可以使用 “公共” 选项卡检测传真音调。";
	...
	//schema details
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "要连接到的服务器。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "验证证书与否。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "要监控的邮箱文件夹。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "主题标记以检测入站传真。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "主题标记以检测出站传真。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "授权的电子邮件到传真发件人地址。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "TIF / PDF";
		$z++;
