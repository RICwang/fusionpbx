...
$text['label-fax_local_station_id']['zh-cn'] = "本地站标识";
...
$text['label-fax_image_size']['zh-cn'] = "图像尺寸";
...
$text['label-fax_document_transferred_pages']['zh-cn'] = "文档转移页面";
...
$text['label-fax-sender']['zh-cn'] = "来自";
...
$text['label-fax-cover-sheet']['zh-cn'] = "盖板";
...
$text['label-fax-attached']['zh-cn'] = "附";
...
$text['label-fax_send_channels']['zh-cn'] = "频道数量";
...
$text['header-sent_faxes']['zh-cn'] = "发送";
...
$text['description-pin']['zh-cn'] = "在此输入密码。";
...
$text['description-fax_transfer_rate']['zh-cn'] = "通信的传输速率。";
...
$text['description-fax_log']['zh-cn'] = "包括发送和接收传真的详细信息包括传真是否成功，ECM (纠错模式)，重试次数，目标编号，日期等。";
...
$text['description-fax_document_transferred_pages']['zh-cn'] = "转移的页数。";
...
$text['description-fax-message']['zh-cn'] = "为封面输入消息 (可选)。";
...
$text['description-email_inbound_subject_tag']['zh-cn'] = "设置入站传真的电子邮件主题标签。";
...
$text['description-email_connection_validate']['zh-cn'] = "启用服务器证书验证。<br>(为自签名证书选择 “错误”。)";
...
$text['description-caller-id-name']['zh-cn'] = "在此输入来电显示名称。";
...
$text['description-3']['zh-cn'] = "安装LibreOffice以获得额外的文件格式支持 (DOC、DOCX、XLS、XLSX、ODT、OTT、RTF等)。在 “活动呼叫” 页面、 “日志查看器” 中或通过在交换机控制台中观看结果来查看传真传输的状态。";
...
$text['description']['zh-cn'] = "要接收传真，请设置传真分机，然后将传入内容定向到传真分机。";
...
$text['confirm-fax']['zh-cn'] = "请提供: 一份传真文件";
...
$text['confirm-ext']['zh-cn'] = "请提供: 一个分机号码";
