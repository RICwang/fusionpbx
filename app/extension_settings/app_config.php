<?php
	...
	//Extension Settings
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = '输入已启用的扩展。';
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = '输入扩展名描述。';
		$z++;
