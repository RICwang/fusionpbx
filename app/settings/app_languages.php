...
$text['label-xml_rpc_auth_user']['zh-cn'] = "XML RPC授权用户";
...
$text['label-xml_rpc_auth_realm']['zh-cn'] = "XML RPC授权领域";
...
$text['label-xml_rpc_auth_pass']['zh-cn'] = "XML RPC身份验证密码";
...
$text['label-xml_rpc_http_port']['zh-cn'] = "XML RPC HTTP端口";
...
$text['label-mod_shout_volume']['zh-cn'] = "Mod喊叫音量";
...
$text['label-mod_shout_decoder']['zh-cn'] = "Mod喊叫解码器";
...
$text['label-event_socket_acl']['zh-cn'] = "事件套接字ACL";
...
$text['description-xml_rpc_auth_user']['zh-cn'] = "输入XML RPC身份验证用户。默认值: xmlrpc";
...
$text['description-xml_rpc_auth_realm']['zh-cn'] = "输入XML RPC授权领域。默认: freeswitch";
...
$text['description-xml_rpc_auth_pass']['zh-cn'] = "输入XML RPC身份验证密码。";
...
$text['description-mod_shout_volume']['zh-cn'] = "输入Mod喊叫音量。";
...
$text['description-event_socket_ip']['zh-cn'] = "输入事件套接字ip地址。默认值: 127.0.0.1";
