...
$text['title_description-call_broadcast']['zh-cn'] = "管理预先录制的消息向海量收件人的传递。";
...
$text['label-view-calls']['zh-cn'] = "查看调用";
...
$text['label-has-been']['zh-cn'] = "已经启动了";
...
$text['label-sample_file']['zh-cn'] = "示例CSV文件";
...
$text['label-list_example']['zh-cn'] = "数字 | 第一，最后 \ n数字 | 第一，最后 \ n...";
...
$text['description-start_time']['zh-cn'] = "是开始发送呼叫的时间 (以秒为单位)。";
...
$text['description-timeout']['zh-cn'] = "指定以秒为单位的绝对超时时间。";
...
$text['description-phone']['zh-cn'] = "选择一个TXT/CSV文件进行上传，或者按上面显示的格式输入每行一个电话号码。";
...
$text['description-concurrent-limit']['zh-cn'] = "限制并发调用的大致数量。把这个留空无限制。";
...
$text['description-caller-id-number']['zh-cn'] = "如果允许发送来电显示号码的提供商适用。默认值: 0000000000";
...
$text['description-caller-id-name']['zh-cn'] = "如果提供商允许设置呼叫者ID名称，则适用。默认: 匿名";
...
$text['description-avmd']['zh-cn'] = "选择是启用还是禁用语音邮件消息和答录机系统的检测。";
...
$text['description-broadcast_toll_allow']['zh-cn'] = "在此处输入通行费允许值。(例如: 国内、国际、本地)";
...
$text['confirm-delete-info']['zh-cn'] = "你真的要删除这个吗？";
...
$text['file-error']['zh-cn'] = "抱歉，不允许文件类型";
