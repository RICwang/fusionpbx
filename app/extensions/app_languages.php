...
$text['title-extension-add']['zh-cn'] = "扩展添加";
...
$text['option-voicemail_file_listen']['zh-cn'] = "监听链接 (需要登录)";
...
$text['label-voicemail_mail_to']['zh-cn'] = "语音邮件至";
...
$text['label-voicemail_transcription_enabled']['zh-cn'] = "转录启用";
...
$text['label-voicemail_enabled']['zh-cn'] = "已启用语音邮件";
...
$text['label-sip_force_expires']['zh-cn'] = "SIP强制到期";
...
$text['label-rewrite_tls_contact_port']['zh-cn'] = "重写TLS联系端口";
...
$text['label-provisioning']['zh-cn'] = "设备供应";
...
$text['label-outbound_caller_id_number']['zh-cn'] = "出站来电显示号码";
...
$text['label-number_alias']['zh-cn'] = "数字别名";
...
$text['label-hold_music']['zh-cn'] = "持有音乐";
...
$text['label-dial_string']['zh-cn'] = "拨号串";
...
$text['label-bypass_media_after_bridge']['zh-cn'] = "桥后旁路介质";
...
$text['label-bypass_media']['zh-cn'] = "旁路介质";
...
$text['label-billing_warning']['zh-cn'] = "已安装帐单，请注意，您需要有足够的余额来创建扩展。";
...
$text['label-extension_only']['zh-cn'] = "仅扩展";
...
$text['header-extension-add']['zh-cn'] = "扩展添加";
...
$text['description-voicemail_mail_to']['zh-cn'] = "输入要将语音邮件发送到的电子邮件地址 (可选)。";
...
$text['description-voicemail_transcription_enabled']['zh-cn'] = "选择是否为此扩展启用了语音邮件转录";
...
$text['description-voicemail_enabled']['zh-cn'] = "为此扩展启用/禁用语音邮件。";
...
$text['description-user_list']['zh-cn'] = "将用户分配给此扩展。";
...
$text['description-toll_allow']['zh-cn'] = "在此处输入通行费允许值。(例如: 国内、国际、本地)";
...
$text['description-sip_force_expires']['zh-cn'] = "为了防止过时的注册，SIP Force过期可以覆盖客户端过期。";
...
$text['description-sip_force_contact']['zh-cn'] = "选择是重写联系人端口，还是重写联系人IP和端口。";
...
$text['description-sip_bypass_media']['zh-cn'] = "选择是点对点还是透明代理模式发送媒体流。";
...
$text['description-range']['zh-cn'] = "输入要创建的扩展数量。将每个扩展增加1。";
...
$text['description-password']['zh-cn'] = "在这里输入密码。";
...
$text['description-outbound_caller_id_number-custom']['zh-cn'] = "在此输入外部 (公共) 来电显示号码。";
...
$text['description-outbound_caller_id_name-custom']['zh-cn'] = "在此输入外部 (公共) 呼叫者ID名称。";
...
$text['description-mwi_account']['zh-cn'] = "具有要监视的语音邮件的user @ 域的MWI帐户。";
...
$text['description-force_ping']['zh-cn'] = "使用选项检测扩展是否可到达";
...
$text['description-max_registrations']['zh-cn'] = "输入此用户允许的最大注册";
...
$text['description-limit_max']['zh-cn'] = "输入此用户的最大呼出次数。";
...
$text['description-limit_destination']['zh-cn'] = "当达到最大呼出次数时，输入发送呼叫的目的地。";
...
$text['description-extensions']['zh-cn'] = "使用它来配置您的SIP扩展。";
...
$text['description-extension']['zh-cn'] = "输入字母数字扩展名。默认配置允许2-15位数字扩展名。";
...
$text['description-emergency_caller_id_number']['zh-cn'] = "在此输入紧急来电显示号码。";
...
$text['description-emergency_caller_id_name']['zh-cn'] = "在此输入紧急来电显示名称。";
...
$text['description-effective_caller_id_name']['zh-cn'] = "在此输入内部来电显示名称。";
...
$text['description-directory_exten_visible']['zh-cn'] = "选择在调用目录时是否宣布分机。";
...
$text['description-cidr']['zh-cn'] = "以CIDR表示法 (逗号分隔) 输入允许的地址/范围。";
...
$text['description-call_group']['zh-cn'] = "在此进入用户呼叫组。默认情况下可用的组: 销售、支持、计费。";
...
$text['description-auth_acl']['zh-cn'] = "在这里输入授权ACL。";
...
$text['description-accountcode']['zh-cn'] = "在这里输入帐户代码。";
...
$text['description-extension_export']['zh-cn'] = "选择要包括在导出中的字段。";
...
$text['button-call_forward']['zh-cn'] = "呼叫转发";
