...
$text['description-conference_controls']['zh-cn'] = "调用控件使能够为操作分配数字。它们可用于在电话会议期间静音、取消静音或其他操作。";
...
$text['title_description-conference_control_detail']['zh-cn'] = "调用控件使能够为操作分配数字。它们可用于在电话会议期间静音、取消静音或其他操作。";
