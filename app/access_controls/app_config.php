<?php
	...
	//application details
		...
		$apps[$x]['description']['zh-cn'] = "Manage access control lists";
	...
	//schema details
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "Enter the name.";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "access_control_default";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['search'] = 'true';
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the default type.";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "Select the default type.";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "access_control_description";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['search'] = 'true';
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enter the description";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "Enter the description";
		$z++;
