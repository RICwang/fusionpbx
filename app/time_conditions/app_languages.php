...
$text['message-alternate_destination_required']['zh-cn'] = "需要替代目的地";
...
$text['label-week-of-month']['zh-cn'] = "每月的一周";
...
$text['label-required-dialplan_name']['zh-cn'] = "请提供: 扩展名名称";
...
$text['label-preset_martin_luther_king_jr_day']['zh-cn'] = "小马丁·路德·金日";
...
$text['label-minute-of-hour']['zh-cn'] = "分钟小时";
...
$text['label-minute-of-day']['zh-cn'] = "一天中的分钟";
...
$text['label-day-of-month']['zh-cn'] = "月中的一天";
...
$text['description-time_conditions']['zh-cn'] = "根据时间条件动态地将调用路由到IVR菜单、外部号码、脚本或其他目的地。";
...
$text['description-settings']['zh-cn'] = "定义执行上面选择的目标所需的自定义条件。";
...
$text['description-presets_advanced']['zh-cn'] = "选择上面的默认目标，以 <i> 应用于 </i> 检查的每个预设 (未定义目标)。";
...
$text['description-presets']['zh-cn'] = "从可用预设中选择。单击预设名称以进一步自定义每个的条件和/或目的地。";
