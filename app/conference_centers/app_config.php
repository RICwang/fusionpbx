<?php
	...
	//schema details
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "在开始时间打开会议室。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "进入会议时宣布参加人数。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "向与会者宣布会议正在记录。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "会议 _ uuid";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "profile";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select the conference profile.";
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "开始 _ 时代";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "end_epoch";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "end_epoch";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "结束 _ 时代";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "insert_date";
		$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = 'timestamptz';
		$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = 'date';
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "调用UUID";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "moderator";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Moderator";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "主持人";
		$z++;
