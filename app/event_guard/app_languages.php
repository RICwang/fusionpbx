<?php
	...
	//Event Guard
		...
		$text['title-event_guard_logs']['zh-cn'] = '事件保护';
		...
		$text['title-event_guard_log']['zh-cn'] = '事件保护';
		...
		$text['description-extension']['zh-cn'] = '输入分机。';
		...
		$text['label-unblocked']['zh-cn'] = “不受封锁”;
