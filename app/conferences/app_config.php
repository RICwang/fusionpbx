<?php
	...
	//application details
		...
		$apps[$x]['description']['zh-cn'] = "会议用于设置带有名称，描述和可选pin号的会议室。";
	...
	//schema details
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "可选的pin号码，以确保对会议的访问。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "会议简介是会议设置的集合。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "可选的会议标志。例子: 哑巴 | 聋子 | 废物 | 版主";
		$z++;
