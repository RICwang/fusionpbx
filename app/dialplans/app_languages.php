...
$text['title-dialplan_manager']['zh-cn'] = "拨号计划经理";
...
$text['title-inbound_routes']['zh-cn'] = "入站路线";
...
$text['option-week_of_month']['zh-cn'] = "每月的一周";
...
$text['option-on_false']['zh-cn'] = "关于假";
...
$text['option-minute_of_day']['zh-cn'] = "一天中的分钟";
...
$text['option-day_of_year']['zh-cn'] = "一年中的一天";
...
$text['option-day_of_month']['zh-cn'] = "月中的一天";
...
$text['label-dialplan_detail']['zh-cn'] = "Dialplan详细信息";
...
$text['header-inbound_routes']['zh-cn'] = "入站路线";
...
$text['header-dialplan_manager']['zh-cn'] = "拨号计划经理";
...
$text['description-time_conditions']['zh-cn'] = "时间条件基于时间条件路由呼叫。您可以使用时间条件将呼叫发送到IVR菜单、外部号码、脚本或其他目的地。";
...
$text['description-queues']['zh-cn'] = "队列用于设置呼叫者的等待线。也称为FIFO队列。";
...
$text['description-outbound_routes']['zh-cn'] = "路由出站呼叫到网关、tdm、enum等。当呼叫与条件匹配时，呼叫到出站路由。";
...
$text['description-inbound_routes']['zh-cn'] = "根据一个或多个条件将来电路由到目的地。它可以将来电发送到IVR菜单，呼叫组，分机，外部号码，脚本。当使用反动作或有多个条件匹配时，顺序很重要。";
...
$text['description-dialplan_manager-superadmin']['zh-cn'] = "拨号计划用于根据条件和上下文设置呼叫目的地。您可以使用dialplan将呼叫发送到网关、自动服务员、外部号码、脚本或任何目的地。";
...
$text['description-dialplan_manager']['zh-cn'] = "dialplan提供了一些功能代码以及IVR菜单，会议，队列和其他目的地的视图。";
...
$text['description-dialplan-edit']['zh-cn'] = "Dialplan包括常规设置。";
...
$text['description-default_dialplan']['zh-cn'] = "默认的dialplan用于根据条件和上下文设置呼叫目的地。您可以使用dialplan将呼叫发送到网关、自动服务员、外部号码、脚本或任何目的地。";
...
$text['description-conditions_and_actions']['zh-cn'] = "拨号计划中使用以下条件，操作和反操作来指导呼叫流。每个都按照给出的顺序进行处理。根据需要使用尽可能多的条件、动作或反动作。";
...
$text['billing-warning']['zh-cn'] = "如果您使用的是fusionpbx计费应用程序，请确保添加帐户代码和运营商变量。";
