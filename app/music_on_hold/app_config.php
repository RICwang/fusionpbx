<?php
	...
	//application details
		...
		$apps[$x]['description']['zh-cn'] = "在保留文件上添加、删除或播放音乐。";
	...
	//schema details
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "8000，16000，32000，48000";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "music_on_hold_shuffle";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "true/false";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "真/假";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "柔软的";
		$z++;
