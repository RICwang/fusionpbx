...
$text['title-destination_import']['zh-cn'] = "目标导入";
...
$text['title-destination_export']['zh-cn'] = "目的地导出";
...
$text['label-monthly_price_buy']['zh-cn'] = "每月买入价格";
...
$text['label-destination_trunk_prefix']['zh-cn'] = "主干前缀";
...
$text['label-destination_cid_name_prefix']['zh-cn'] = "来电显示姓名前缀";
...
$text['label-destination_hold_music']['zh-cn'] = "持有音乐";
...
$text['label-destination_distinctive_ring']['zh-cn'] = "独特的戒指";
...
$text['header-destination_import']['zh-cn'] = "目标导入";
...
$text['header-destination_export']['zh-cn'] = "目的地导出";
...
$text['description-destination_import']['zh-cn'] = "上传分隔符数据以添加多个目的地。";
...
$text['description-destination_export']['zh-cn'] = "选择要包括在导出中的字段。";
...
$text['description-monthly_price_buy']['zh-cn'] = "输入您为此目的地支付的每月价格 (仅在入站时)";
...
$text['description-monthly_price']['zh-cn'] = "输入每月价格以支付此目的地的账单 (仅在入站时)";
...
$text['description-providers']['zh-cn'] = "将此目的地分配给提供者。";
...
$text['description-destination_condition_field']['zh-cn'] = "输入目标条件。";
...
$text['description-destination_trunk_prefix']['zh-cn'] = "输入主干前缀。";
...
$text['description-group']['zh-cn'] = "将目标分配给一个组。";
...
$text['description-destination_order']['zh-cn'] = "选择订单。";
...
$text['description-carrier']['zh-cn'] = "输入运营商名称。这用于跟踪案例计费";
...
$text['description-destination_hold_music']['zh-cn'] = "在此处选择MOH类别。";
...
$text['description-destination_distinctive_ring']['zh-cn'] = "为独特的戒指选择声音。";
