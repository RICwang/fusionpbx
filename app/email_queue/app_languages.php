<?php
	...
	//Email Queue
		...
		$text['label-email_from']['zh-cn'] = 'From';
		...
		$text['description-email_to']['zh-cn'] = '输入到的电子邮件。';
		...
		$text['label-email_subject']['zh-cn'] = '主体';
		...
		$text['label-email_action_before']['zh-cn'] = '在电子邮件之前';
		...
		$text['label-email_action_after']['zh-cn'] = '邮件后';
		...
		$text['label-email_retry_count']['zh-cn'] = '回撤';
