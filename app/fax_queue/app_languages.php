<?php
	...
	//FAX Queue
		...
		$text['label-fax_uuid']['zh-cn'] = '传真id';
		...
		$text['description-fax_date']['zh-cn'] = “传真的日期进入了队列。”;
		...
		$text['description-fax_retry_date']['zh-cn'] = '传真被重发的日期';
		...
		$text['description-fax_notify_date']['zh-cn'] = “传真被通知的日期”;
		...
		$text['description-fax_retry_count']['zh-cn'] = '输入传真重试。';
