<?php
	...
	//schema details
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入呼叫超时时间。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入呼叫转发目的地。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择启用或禁用环组呼叫转发。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择跟随环组目的地的呼叫转发。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择跟随环组目的地的跟随我。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择启用或禁用环组。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "通行费允许环组前进。";
		$z++;
