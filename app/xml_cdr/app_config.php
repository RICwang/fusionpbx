<?php
	...
	//application details
		...
		$apps[$x]['description']['zh-cn'] = "呼叫详细记录与呼叫有关的所有信息。";
	...
	//schema details
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "指示是否进行了记录。如果记录存在，则将此值设置为true。";
		$apps[$x]['db'][$y]['fields'][$z]['deprecated'] = "true";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "呼叫a或b的腿。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "始发腿UUID。用于识别企业环组的支腿-并排除它们";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "拨号后延迟 (PDD)，以毫秒为单位。除以1000几秒钟。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "队列uuid";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "来电者加入队列时的纪元";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "cc_queue";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Queue";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "队列";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "代理名称";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "桥接的真或假";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "队列回答时代";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "队列终止时代";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "数字拨号";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "pin_number";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "pin number";
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "引脚号";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "救谁挂了或取消了腿。";
		$z++;
