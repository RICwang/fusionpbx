...
$text['label-select-inbound-destination-number']['zh-cn'] = "选择入站目标号码。";
...
$text['description-caller-id-number-prefix']['zh-cn'] = "在呼叫者ID号码上设置前缀。";
...
$text['description-dialplan-inbound-add']['zh-cn'] = "公共拨号计划用于根据一个或多个条件和上下文将传入呼叫路由到目的地。它可以将来电发送到自动助理，huntgroup，分机，外部号码或脚本。";
