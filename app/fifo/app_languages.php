...
$text['title-queue_detail_add']['zh-cn'] = "队列详细信息添加";
...
$text['header-queue_detail_add']['zh-cn'] = "队列详细信息添加";
...
$text['description-queue_edit']['zh-cn'] = "队列用于设置呼叫者的等待线。也称为FIFO队列。";
...
$text['description-queue_add']['zh-cn'] = "简而言之，队列是呼叫者等待的模式，直到有人可以接听电话为止。也称为FIFO队列。";
...
$text['description-continue']['zh-cn'] = "Continue在大多数情况下应该设置为false。";
...
$text['description-conditions_and_actions']['zh-cn'] = "拨号计划中使用以下条件，操作和反操作来指导呼叫流。每个操作都按顺序进行处理，直到您到达指示要执行的操作dialplan_detail_tag为止。对于给定的扩展名，您不仅限于一个条件或操作dialplan_detail_tag。";
...
$text['description-agent_queue_extension']['zh-cn'] = "代理拨打的分机号码，以等待呼叫进入队列，或接听队列中的呼叫。代理将听到保持音乐，直到呼叫者进入队列并且呼叫已连接。";
...
$text['description-agent_loginout_extension']['zh-cn'] = "代理使用此分机号登录或注销队列。在提示下，拨打1登录，2注销。登录后，代理将准备接收来自队列的呼叫。";
