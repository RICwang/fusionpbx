...
$text['heading-recent_calls']['zh-cn'] = "最近的电话";
...
$text['label-ring_group']['zh-cn'] = "环群";
...
$text['label-add-note']['zh-cn'] = "阻止来自某个号码的呼叫。从上面的列表中选择一个数字，或在下面输入数字，名称和启用。";
...
$text['description-extension']['zh-cn'] = "选择要受影响的扩展。";
...
$text['description-enable']['zh-cn'] = "设置为true以启用此号码的呼叫阻塞。";
...
$text['description-action']['zh-cn'] = "为来自该号码的呼叫设置一个操作。";
...
$text['confirm-block']['zh-cn'] = "你真的想阻止这个吗？";
