<?php
	...
	//application details
		...
		$apps[$x]['description']['zh-cn'] = "管理mod_translation";
	...
	//Number Translations
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = '输入数字译名。';
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = '输入启用的数字翻译。';
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = '输入数字翻译说明。';
		$z++;
	...
	//Number Translation Details
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = '输入数字翻译详细信息替换。';
		$z++;
