...
$text['title-number_translation']['zh-cn'] = '数字翻译';
...
$text['label-number_translation_detail_regex']['zh-cn'] = “常规表达”;
...
$text['description-number_translation_detail_regex']['zh-cn'] = '输入用于标识要替换的数字的正则表达式。';
...
$text['description-number_translation_detail_replace']['zh-cn'] = '输入数字翻译详细信息替换。';
...
$text['label-number_translation_detail_order']['zh-cn'] = '订单';
...
$text['description-number_translation_name']['zh-cn'] = '输入数字译名。';
...
$text['description-number_translation_enabled']['zh-cn'] = '输入启用的数字翻译。';
...
$text['description-number_translation_description']['zh-cn'] = '输入数字翻译说明。';
