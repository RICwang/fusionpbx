<?php
	...
	//application details
		...
		$apps[$x]['description']['zh-cn'] = "用于调配的设备。";
	...
	//schema details
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入sip服务器主地址。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入sip服务器辅助地址。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "输入auth ID。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "选择是否从用户组中保护此密钥。";
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = "图标名称。";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "insert_date";
		$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = 'timestamptz';
		$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = 'date';
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = '输入已启用的配置文件设置。';
		$z++;
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['zh-cn'] = '输入配置文件设置说明。';
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "insert_date";
		$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = 'timestamptz';
		$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = 'date';
