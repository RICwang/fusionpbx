...
$text['message-moved_up']['zh-cn'] = "项目向上移动";
...
$text['label-menu_order']['zh-cn'] = "订单";
...
$text['description-protected']['zh-cn'] = "启用此功能可以保护菜单项不被 “恢复默认” 删除。";
...
$text['confirm-restore']['zh-cn'] = "您将恢复此菜单上的所有 <i> 未受保护的 </i> 项。";
