...
$text['message-upgrade_permissions']['zh-cn'] = "权限默认恢复";
...
$text['message-upgrade_source_scripts']['zh-cn'] = "更新了源文件和脚本";
...
$text['message-upgrade_source']['zh-cn'] = "更新源文件";
...
$text['message-upgrade_menu']['zh-cn'] = "菜单默认值已恢复";
...
$text['login-message_text']['zh-cn'] = "通过在系统菜单下的新添加的 <a href = ''/core/notification_edit.php''> 通知 </a> 部分中配置首选项来跟上FusionPBX项目!";
...
$text['label-upgrade_apps']['zh-cn'] = "应用默认";
...
$text['description-upgrade']['zh-cn'] = "选择您希望执行的以下操作。";
