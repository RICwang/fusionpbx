<?php
	...
	//Dashboard
		...
		$text['label-group_uuid']['zh-cn'] = '团体uuid';
		...
		$text['label-dashboard_groups']['zh-cn'] = '群体';
		...
		$text['description-dashboard_groups']['zh-cn'] = '添加具有此小部件权限的组。';
		...
		$text['label-dashboard_order']['zh-cn'] = '订单';
