...
$text['message-disclaimer']['zh-cn'] = "<u> 披露 </u>: 启用项目通知是同意收集有关安装环境的 <i> 匿名 </i> 和 <i> 一般 </i> 人口统计信息。请求的信息包括以下内容: 1) FusionPBX版本，2) PHP版本，3) web服务器和版本，4) 语音交换机版本，5) 数据库类型和版本，6) 操作系统平台和版本，以及7) 公共ip地址。如果您不希望提交此信息，只需禁用项目通知，就不会提交有关您系统的任何信息。";
...
$text['message-demographics_submitted']['zh-cn'] = "提交的人口统计数据";
...
$text['message-demographics']['zh-cn'] = "<u> 注意 </u>: 要通过提交上述人口统计信息来帮助FusionPBX项目，而无需 </i> 订阅项目通知，只需";
...
$text['description-project_events']['zh-cn'] = "接收即将到来的FusionPBX培训班，会议摊位以及与该项目相关的其他活动的通知。";
