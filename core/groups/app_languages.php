...
$text['description-groups']['zh-cn'] = '组是用户的逻辑组织。组被分配权限。用户从分配给他们的一个或多个组继承权限。默认组是全局的，并在所有域中使用。可以创建与一个域相关的组，并将其分配给单个域。;
...
$text['message-default_system_group']['zh-cn'] = "默认系统组不能编辑或删除。";
...
$text['label-group_level']['zh-cn'] = '水平';
...
$text['description-user_setting-add']['zh-cn'] = "为此用户添加一个设置。";
...
$text['description-user_edit']['zh-cn'] = "编辑用户信息和组成员资格。";
...
$text['description-user_add']['zh-cn'] = "要添加用户，请完整填写此表格。所有字段都是必填项。";
...
$text['description-group_permissions']['zh-cn'] = "为该组分配权限。";
...
$text['description-contact']['zh-cn'] = "为此用户帐户分配一个联系人。";
...
$text['description-api_key']['zh-cn'] = "输入API密钥通常是UUID。API密钥应为128位或更大。";
